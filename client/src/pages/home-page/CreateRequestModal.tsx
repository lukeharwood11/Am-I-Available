...
import { CreateEventRequestRequest, EventDateTime } from "../../redux/types/event-requests.types";
    ...
    return (
        ...
        >
            <div className={styles.createRequestModal}>
                ...
                <DatePicker includeTime value={formData.start_date} onChange={(date) => setFormData({ ...formData, start_date: date || '' })} placeholder="Enter start date" fullWidth />
                <DatePicker includeTime value={formData.end_date} onChange={(date) => setFormData({ ...formData, end_date: date || '' })} placeholder="Enter end date" fullWidth />
