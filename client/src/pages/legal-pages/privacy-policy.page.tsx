                ...
                <Card variant="elevated" padding="large" className={styles.contentCard}>
                    ...
                    <div className={styles.content}>
                        <section className={styles.section}>
                            ...
                            <Text variant="heading-small" color="primary" className={styles.subsectionTitle}>
                        ...
                        <section className={styles.section}>
                            ...
                            <p>
                                Our service is not intended for children under <u>13 years of age</u>. We do not knowingly collect personal information from children under this age.
                            </p>
                        </section>
                        ...
                        <section className={styles.section}>
                            ...
                            <div className={styles.contactInfo}>
                                <p><strong>Email:</strong> <u>privacy@amiavailable.com</u></p>
                                <p><strong>Address:</strong> <u>Will Update Soon</u></p>
