                ...
                <Card variant="elevated" padding="large" className={styles.contentCard}>
                    ...
                    <div className={styles.content}>
                        ...
                        <section className={styles.section}>
                            ...
                            <ul className={styles.list}>
                                <li><strong>Analytics providers:</strong> <u>Google Analytics, Mixpanel</u></li>
                                <li><strong>Authentication services:</strong> <u>Supabase, Auth0</u></li>
                                <li><strong>Content delivery networks:</strong> <u>Cloudflare, AWS CloudFront</u></li>
                                <li><strong>Social media platforms:</strong> <u>Facebook, Twitter, LinkedIn</u></li>
                            </ul>
                        </section>

                        <section className={styles.section}>
                            <h2 className={styles.sectionTitle}>4. Cookie Duration</h2>
                            <p>Cookies can be classified by their duration:</p>
                            
                            <h3 className={styles.subsectionTitle}>Session Cookies</h3>
                            <p>
                                These are temporary cookies that expire when you close your browser. They are essential for the website's functionality during your visit.
                            </p>

                            <h3 className={styles.subsectionTitle}>Persistent Cookies</h3>
                            <p>
                                These cookies remain on your device for a set period or until you delete them. They remember your preferences across multiple visits.
                            </p>
                        </section>
                        ...
                        <section className={styles.section}>
                            ...
                            <h3 className={styles.subsectionTitle}>Cookie Consent</h3>
                            <p>
                            ...
                            <h3 className={styles.subsectionTitle}>Opt-Out Tools</h3>
                            <p>
                                For certain advertising cookies, you can use industry opt-out tools:
                            </p>
                            <ul className={styles.list}>
                                <li><u>Digital Advertising Alliance (DAA)</u></li>
                                <li><u>Network Advertising Initiative (NAI)</u></li>
                                <li><u>European Interactive Digital Advertising Alliance (EDAA)</u></li>
                            </ul>
                        </section>
                        ...
                        <section className={styles.section}>
                            ...
                            <div className={styles.contactInfo}>
                                <p><strong>Email:</strong> Will Update Soon</p>
                                <p><strong>Address:</strong> Will Update Soon</p>
                            </div>
                        </section>
                    </div>
                </Card>
