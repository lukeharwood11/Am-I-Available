                    ...
                    <div className={styles.content}>
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                By accessing and using Am I Available ("the
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                Am I Available is a platform that helps users
                                coordinate events and manage their availability.
                                The Service includes features for creating
                                events, managing relationships, and facilitating
                        ...
                        <section className={styles.section}>
                            ...
                            <ul className={styles.list}>
                                ...
                                <li>
                                    Transmit any harmful, threatening, abusive,
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                ...
                                exclusive property of <u>Am I Available</u> and
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                The information on this Service is provided on
                                an "as is" basis. To the fullest extent
                                permitted by law, <u>Am I Available</u> excludes
                                all representations, warranties, conditions and
                                terms relating to our Service and the use of
                                this Service.
                            </Text>
                        </section>
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                In no event shall <u>Am I Available</u>, nor its
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                ...
                                the laws of <u>Your Jurisdiction</u>, without
                        ...
                        <section className={styles.section}>
                            ...
                            <Text variant='body' color='grey-700'>
                                ...
                                <u>30 days</u> notice prior to any new terms
                                taking effect.
                            </Text>
                        </section>
