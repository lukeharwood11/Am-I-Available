      ...
      <div className={styles.aboutContent}>
        ...
        >
          ...
          <motion.h2 className={styles.title} variants={itemVariants}>
            The Future of
            <br />
            <span className={styles.highlight}>Calendar Management</span>
          </motion.h2>
          ...
          <motion.div className={styles.benefits} variants={itemVariants}>
            ...
            <motion.div className={styles.benefit} variants={itemVariants}>
              <MdSentimentSatisfied className={styles.benefitIcon} />
              <div className={styles.benefitText}>
                <h4>Reduce Stress</h4>
                <p>Eliminate scheduling conflicts and last-minute changes</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.visualCard} variants={itemVariants}>
            ...
            <div className={styles.cardContent}>
              ...
              <div className={styles.aiActions}>
                <div className={styles.actionButton}>Accept</div>
                <div className={styles.actionButton}>Modify</div>
                <div className={styles.actionButton}>Decline</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
