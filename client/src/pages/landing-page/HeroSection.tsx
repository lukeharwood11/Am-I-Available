    ...
    <section id='hero' className={styles.hero}>
      <div className={styles.heroContent}>
          ...
          {!mediaQuery && (
            <>
              ...
              <span className={styles.statsDisclaimer}>
                *Based on one user's feedback, who happens to be the creator of
                AM/A
              </span>
            </>
          )}
        ...
        {!mediaQuery && (
          ...
          >
            <motion.div
              className={styles.calendarMockup}
                  ...
                  <div key={i} className={styles.calendarDay}>
                    ...
                    {i >= 7 && (
                      <div className={styles.dayNumber}>
                        {i - 6}
                        {i === 10 && (
                          <div className={styles.meetingSlot}>9:00 AM</div>
                        )}
                        {i === 15 && (
                          <div className={styles.meetingSlot}>2:00 PM</div>
                        )}
                        {i === 20 && (
                          <div className={styles.meetingSlot}>4:30 PM</div>
                        )}
                      </div>
                    )}
                  </div>
