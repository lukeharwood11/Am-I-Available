      ...
      <div className={styles.featuresContent}>
        <div className={styles.sectionHeader}>
          ...
          <h2 className={styles.title}>
            ...
            <span className={styles.highlight}>modern relationships</span>
          </h2>
          <p className={styles.subtitle}>
            Everything you need to manage your calendar, relationships, and
            events in one beautiful, intuitive platform.
          </p>
        </div>
