...
const eventRequestsSlice = createSlice({
    ...
    reducers: {
        ...
        setEventRequests: (
            state,
            action: PayloadAction<EventRequestData[]>
        ) => {
        ...
        builder
            ...
            .addCase(
                ...
                (state, action) => {
                    ...
                    state.error.eventRequestsWithApprovals =
            ...
            .addCase(
                ...
                (state, action) => {
                    state.loading.currentEventRequestWithApprovals = false;
                    state.currentEventRequestWithApprovals =
                        action.payload.event_request;
                }
            )
            .addCase(updateEventRequestThunk.fulfilled, (state, action) => {
                ...
                if (eventRequestWithApprovalsIndex !== -1) {
                    ...
                    const existingWithApprovals =
                        state.eventRequestsWithApprovals[
                            eventRequestWithApprovalsIndex
                        ];
                    if (existingWithApprovals) {
                        state.eventRequestsWithApprovals[
                            ...
                            approval_status:
                                existingWithApprovals.approval_status,
                            requested_approvals:
                                existingWithApprovals.requested_approvals,
                            completed_count:
                                existingWithApprovals.completed_count,
                        };
                    }
                }
            ...
            .addCase(deleteEventRequestThunk.fulfilled, (state, action) => {
                ...
                state.eventRequestsWithApprovals =
                    state.eventRequestsWithApprovals.filter(
                        r => r.id !== requestId
                    );
