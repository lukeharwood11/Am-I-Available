...
const relationshipSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            ...
            .addCase(
                createRelationshipRequestThunk.rejected,
                (state, action) => {
            ...
            .addCase(
                fetchSentRelationshipRequestsThunk.rejected,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.error.relationshipRequests = action.payload as string;
                }
            ...
            .addCase(
                fetchRelationshipRequestThunk.rejected,
                (state, action) => {
                    state.loading.currentRelationshipRequest = false;
                    state.error.currentRelationshipRequest =
                        action.payload as string;
                }
            )
            .addCase(
                updateRelationshipRequestThunk.rejected,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.error.relationshipRequests = action.payload as string;
                }
            ...
            .addCase(
                deleteRelationshipRequestThunk.rejected,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.error.relationshipRequests = action.payload as string;
                }
            ...
            .addCase(
                approveRelationshipRequestThunk.rejected,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.error.relationshipRequests = action.payload as string;
                }
            ...
            .addCase(
                rejectRelationshipRequestThunk.rejected,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.error.relationshipRequests = action.payload as string;
                }
            ...
            .addCase(
                createRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.relationshipRequests = false;
            ...
            .addCase(
                fetchRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.currentRelationshipRequest = false;
            ...
            .addCase(
                updateRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.relationshipRequests = false;
            ...
            .addCase(
                deleteRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.relationshipRequests = false;
            ...
            .addCase(
                approveRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.relationshipRequests.received =
                        state.relationshipRequests.received.filter(
            ...
            .addCase(
                rejectRelationshipRequestThunk.fulfilled,
                (state, action) => {
                    state.loading.relationshipRequests = false;
                    state.relationshipRequests.received =
                        state.relationshipRequests.received.filter(
