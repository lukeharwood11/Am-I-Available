...
export const Default: Story = {
    render: args => (
        <ModalWrapper {...args}>
            <p>
                This is the default modal content. You can put any React
                components here.
            </p>
            <p>
...
export const Small: Story = {
    render: args => (
        <ModalWrapper {...args}>
            <p>
                This is a small modal, perfect for confirmations or simple
                forms.
            </p>
...
export const Medium: Story = {
    render: args => (
        <ModalWrapper {...args}>
            <p>
                This is a medium-sized modal, good for most use cases including
                forms and detailed content.
            </p>
...
export const Large: Story = {
    render: args => (
        <ModalWrapper {...args}>
            <p>
                This is a large modal, suitable for complex forms, detailed
...
export const NoTitle: Story = {
    render: args => (
        <ModalWrapper {...args}>
            ...
            <p>
                This modal has no title prop, so you can create your own custom
...
export const NoCloseButton: Story = {
    render: args => (
        <ModalWrapper {...args}>
            <p>
                This modal has no close button. Users can still close it by
