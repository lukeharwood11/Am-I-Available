...
export const Default: Story = {
  args: {
    children: (
      <div>
        <h3 style={{ margin: '0 0 8px 0', color: 'var(--grey-800)' }}>
          Card Title
        </h3>
  ...
  args: {
    header: (
      ...
      >
        ...
        <span style={{ color: 'var(--grey-600)', fontSize: '14px' }}>
          Action
        </span>
      </div>
    ),
  ...
  render: () => (
    ...
    >
      <Card variant='default'>
        <h4 style={{ margin: '0 0 8px 0', color: 'var(--grey-800)' }}>
          Default
        </h4>
        <p style={{ margin: '0', color: 'var(--grey-600)' }}>
  ...
  render: () => (
    <Card variant='elevated' style={{ maxWidth: '300px' }}>
      <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
        ...
        />
        <div style={{ flex: 1 }}>
          <h3 style={{ margin: '0 0 4px 0', color: 'var(--grey-800)' }}>
            John Doe
          </h3>
          <p
            style={{
          ...
          <p
            style={{ margin: '0', color: 'var(--grey-600)', fontSize: '12px' }}
          >
