...
@with_token_refresh
async def _get_calendar_events_with_client(client: GoogleApiClient) -> list[CalendarEvent] | None:
    """
...
async def get_google_calendar_events(access_token: str, refresh_token: str) -> list[CalendarEvent] | None:
    """
...
async def create_event(
    ...
    try:
        client = await create_google_client(access_token, refresh_token)
        return await _create_event_with_client(client, event_data, calendar_id, send_notifications)
    except Exception as e:
...
async def update_event(
    ...
    try:
        client = await create_google_client(access_token, refresh_token)
        return await _update_event_with_client(client, event_id, event_data, calendar_id, send_notifications)
    except Exception as e:
...
async def delete_event(
    ...
    try:
        client = await create_google_client(access_token, refresh_token)
        return await _delete_event_with_client(client, event_id, calendar_id, send_notifications)
    except Exception as e:
...
@with_token_refresh
async def _list_calendars_with_client(client: GoogleApiClient) -> list[CalendarInfo] | None:
    """
...
async def quick_add_event(
    ...
    try:
        client = await create_google_client(access_token, refresh_token)
        return await _quick_add_event_with_client(client, text, calendar_id, send_notifications)
    except Exception as e:
...
async def move_event(
    ...
    try:
        ...
        return await _move_event_with_client(
            client, event_id, destination_calendar_id, source_calendar_id, send_notifications
        )
    except Exception as e:
