...
class EventRequestsDatabridge:
    ...
    async def get_event_request_by_id(self, *, event_request_id: str) -> DBEventRequestResponse | None:
        ...
        try:
            response = self.event_requests.select('*').eq('id', event_request_id).single().execute()
            if not response.data:
                return None
    ...
    async def update_event_request(
        ...
        *, 
        ...
        try:
            ...
            response = self.event_requests.update(update_data).eq('id', event_request_id).execute()
            if not response.data:
                return None
    ...
    async def get_event_request_by_google_id(self, *, google_event_id: str) -> DBEventRequestResponse | None:
        ...
        try:
            response = self.event_requests.select('*').eq('google_event_id', google_event_id).single().execute()
            if not response.data:
                return None
