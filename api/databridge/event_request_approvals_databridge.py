...
class EventRequestApprovalsDatabridge:
    ...
    async def get_event_request_approval_by_id(self, *, approval_id: str) -> DBEventRequestApprovalResponse | None:
        """Get a specific event request approval by ID"""
        try:
            response = self.event_request_approvals.select('*').eq('id', approval_id).single().execute()
            if not response.data:
                return None
    ...
    async def get_approvals_by_event_request(
        ...
        *, 
        ...
        try:
            response = self.event_request_approvals.select('*').eq('event_request_id', event_request_id).execute()
            if not response.data:
                return []
    ...
    async def get_user_pending_approvals(
        ...
        *, 
        ...
        try:
            response = self.event_request_approvals.select('*').eq('user_id', user_id).eq('status', 'pending').execute()
            if not response.data:
                return []
    ...
    async def update_event_request_approval(
        ...
        *, 
        ...
        try:
            ...
            response = self.event_request_approvals.update(update_data).eq('id', approval_id).execute()
            if not response.data:
                return None
    ...
    async def delete_event_request_approval(self, *, approval_id: str) -> bool:
        ...
        try:
            response = self.event_request_approvals.delete().eq('id', approval_id).execute()
    ...
    async def delete_approvals_by_event_request(self, *, event_request_id: str) -> bool:
        ...
        try:
            response = self.event_request_approvals.delete().eq('event_request_id', event_request_id).execute()
    ...
    async def check_existing_approval(
        ...
        *, 
        ...
        try:
            response = self.event_request_approvals.select('*').eq('event_request_id', event_request_id).eq('user_id', user_id).execute()
    ...
    async def check_all_required_approvals_complete(
        ...
        *, 
        ...
        try:
            ...
            response = self.event_request_approvals.select('*').eq('event_request_id', event_request_id).eq('required', True).execute()
