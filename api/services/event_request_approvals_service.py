...
class EventRequestApprovalsService:
    ...
    async def create_event_request_approval(
        ...
        *, 
        ...
        if not db_approval:
            raise HTTPException(
                status_code=500, 
                detail="Failed to create event request approval"
            )
    ...
    async def get_event_request_approval(self, *, approval_id: str) -> EventRequestApprovalResponse:
        ...
        if not db_approval:
            raise HTTPException(
                status_code=404, 
                detail="Event request approval not found"
            )
    ...
    async def get_user_pending_approvals(
        ...
        *, 
        ...
        db_approvals = await self.databridge.get_user_pending_approvals(
            user_id=user_id
        )
    ...
    async def update_event_request_approval(
        ...
        *, 
        ...
        if not db_approval:
            raise HTTPException(
                status_code=500, 
                detail="Failed to update event request approval"
            )
    ...
    async def delete_event_request_approval(
        ...
        *, 
        ...
        if not success:
            raise HTTPException(
                status_code=500, 
                detail="Failed to delete event request approval"
            )
    ...
    async def delete_approvals_by_event_request(
        ...
        *, 
        ...
        if not success:
            raise HTTPException(
                status_code=500, 
                detail="Failed to delete event request approvals"
            )
