...
class RelationshipRequestsService:
    ...
    async def create_relationship_request(
        ...
        *, 
        ...
        if not db_request:
            raise HTTPException(
                status_code=500, 
                detail="Failed to create relationship request"
            )
    ...
    async def get_relationship_request(self, *, request_id: str) -> RelationshipRequestResponse:
    ...
    async def get_sent_relationship_requests(
        ...
        *, 
        ...
        return RelationshipRequestsListResponse(
            relationship_requests=requests,
            count=len(requests),
            filters=filters
        )
    ...
    async def update_relationship_request(
        ...
        *, 
        ...
        if not db_request:
            raise HTTPException(
                status_code=500, 
                detail="Failed to update relationship request"
            )
    ...
    async def delete_relationship_request(
        ...
        *, 
        ...
        if not success:
            raise HTTPException(
                status_code=500, 
                detail="Failed to delete relationship request"
            )
